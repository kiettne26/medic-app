...
class _ChatScreenState extends ConsumerState<ChatScreen> {
  ...
  Future<void> _markAsRead() async {
    ...
    try {
      final url = Uri.parse(
        'https://mocha-exchange-scoff.ngrok-free.dev/api/chat/conversation/$convId/read?readerId=$docUserId',
      );
      await http.post(url);
  ...
  Future<void> _loadChatHistory() async {
    ...
    try {
      ...
      final url = Uri.parse(
        'https://mocha-exchange-scoff.ngrok-free.dev/api/chat/conversation?userId=${widget.conversation.patientId}&doctorId=$_doctorId',
      );
