...
class _ChatScreenState extends ConsumerState<ChatScreen> {
    ...
    client!.subscribe(
      ...
      callback: (StompFrame frame) {
        if (frame.body != null && mounted) {
          ...
          // Skip if this is my own message (already added locally)
          if (data['senderId'] == _userId) return;
          ...
          Expanded(
            child: Column(
              ...
              children: [
                ...
                Text(
                  _connectionStatus, // Show status text
                  style: GoogleFonts.manrope(
                    color: _connectionStatus == 'Connected'
                        ? const Color(0xFF00C853)
                        : Colors.red,
  ...
  Widget _buildDot(int delay) {
    return const _TypingDot(); // Using a separate widget for animation simplicity would be better, but standard dot for now
  }
